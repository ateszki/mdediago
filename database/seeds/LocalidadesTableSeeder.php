...
class LocalidadesTableSeeder extends Seeder {
    public function run()
    {
		...
		DB::statement("insert into paises (`id`, `nombre`) value (1,'Argentina')");
		DB::statement("INSERT INTO `provincias` (`id`, `nombre`,`pais_id`) VALUES
				(1, 'Buenos Aires',1),
				...
				(25, 'Tucumán',1)
			");
		DB::statement("INSERT INTO `localidades` (`id`, `provincia_id`, `nombre`) VALUES
						(1, 1, '25 de Mayo'),
						(2, 1, '3 de febrero'),
						(3, 1, 'A. Alsina'),
