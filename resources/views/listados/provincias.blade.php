    ...
    <div class="boxmedico2">
      <div class="doctors_information">
        ...
        <div class="name_doctors">
          <h1 style="margin-bottom:5px;">Profesionales de la salud Argentina</h1>
  ...
  <tr>
    <td><p>
      ...
      <br>
                    ...
                    <table width="100%%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><input name="" type="text" placeholder="Ciudad o Localidad"></td>
    <td><select name="">
      <option selected>+ Todas las especializaciones</option>
    </select></td>
    <td><select name="">
              ...
              <div class="col-8 media100" style="margin-top:-10px;">
                ...
                <div class="col-10 media100" style="margin-top:-10px;">
                  ...
                  @foreach($provincias as $p)
					  <li><a href="{{URL::to('/regiones/'.$p->slug)}}" title="">Profesionales de la salud en {{$p->nombre}}</a></li>
				  @endforeach	
					</ul>
                  @endif
                                  </div>
